...
const caminhosDasImagens = {
    linha1: '/Projeto - The Duke/Camisa 3/teste 3 camiseta.svg',
    linha2: '/Projeto - The Duke/Camisa 3/teste 3 camiseta (Frente).svg',
    linha3: '/Projeto - The Duke/Camisa 3/teste 3 camiseta (Costas).svg'
};
